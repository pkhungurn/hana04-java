...
public class HanaBinarySerializerByClassCodeGenerator implements CodeGenerator {
  private final Element serializer;
  private final TypeName serialized;

  public HanaBinarySerializerByClassCodeGenerator(Element serializer, TypeName serialized) {
    this.serializer = serializer;
    this.serialized = serialized;
    Util.checkInjectedConstructor(
      serializer,
      "A binary serializer implementation must have a constructor annotated with @Inject. "
  ...
  class Generator implements BindingGenerator {
    ...
    public void generate(TypeSpec.Builder moduleClassBuilder) {
      moduleClassBuilder.addMethod(MethodSpec
        .methodBuilder("provide__" + getUniqueClassName() + "__BinarySerializerByClass")
