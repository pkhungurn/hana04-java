...
public class HanaReadableSerializerByTypeNameCodeGenerator implements CodeGenerator{
  private final Element serializer;
  private final String typeName;

  public HanaReadableSerializerByTypeNameCodeGenerator(Element serializer, String typeName) {
  ...
  class Generator implements BindingGenerator {
    ...
    public void generate(TypeSpec.Builder moduleClassBuilder) {
      moduleClassBuilder.addMethod(MethodSpec
        .methodBuilder("provide__" + getUniqueClassName() + "__ReadableSerializerByTypeName")
        .addAnnotation(Binds.class)
        .addAnnotation(IntoMap.class)
        .addAnnotation(AnnotationSpec.builder(StringKey.class)
          .addMember("value", CodeBlock.builder().add("$S", typeName).build())
          .build())
